...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	...
	*/
		h1{
			/*@editable*/color:#559987 !important;
	...
	*/
		#templatePreheader{
			/*@editable*/background-color:#559987;
			/*@editable*/border-top:3px solid ;
	...
	*/
		.bodyContainer .mcnTextContent,.bodyContainer .mcnTextContent p{
			...
			/*@editable*/font-family:'Helvetica', Times, Baskerville, Georgia, serif;
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0;">
                                        ...
                                        <img align="left" alt="" src="https://gallery.mailchimp.com/7bf1c8cb3b76fd6e7bbbaac0a/images/5151b650-5397-4808-9b46-121aa8e6af22.png" width="239" style="max-width:239px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
            ...
            <td valign="top" class="mcnTextBlockInner" style="padding-top:9px;">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px;color: #47B898;">

                            <h1><span style="color:#559987"><?php echo $email_title; ?></span></h1>
    ...
    <tbody class="mcnButtonBlockOuter">
        <tr>
            <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top" align="center" class="mcnButtonBlockInner">
                <!-- Button Code Below -->
                <!-- <table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 3px;background-color: #559987;">
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 18px; padding: 20px;">
                                <a class="mcnButton " title="Join AgentAssets.com!" href="http://agentassets.com/register?utm_source=apre-beta-free-intro&amp;utm_medium=email&amp;utm_campaign=apre-intro-freesite" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Register on AgentAssets.com</a>
                            </td>
                        </tr>
                    </tbody>
                </table> -->
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <em>Copyright © <?php echo date('Y') ?> AgentAssets.com, All rights reserved.</em>
                            <br><br>
                        </td>
                    </tr>
                </tbody></table>
