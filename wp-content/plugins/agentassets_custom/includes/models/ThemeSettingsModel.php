...
class ThemeSettingsModel extends SiteSettingsModel {
    ...
    public function attributesMetadata()
    {
        return array(
            ...
            'blog_tagline_font_size' => array(
                'label' => 'Blog tagline font',
                'type' => 'number',
                'rules' => array(),
                'section' => 'typography',
                'formIndex' => 6,
            ),
            'blog_tagline_font_face' => array(
                'label' => '',
                'type' => 'select',
                'options' => self::fontList(),
                'rules' => array(),
            ...
            'custom_menu_color' => array(
                'label' => 'Or custom menu color',
                'type' => 'WP_Customize_Color_Control',
                'rules' => array(),
                'section' => 'styling',
                'formIndex' => 27,
            ),
            'disable_menu_background' => array(
                'label' => 'Disable Menu Background',
                'type' => 'checkbox',
                'rules' => array(),
                'section' => 'styling',
                'formIndex' => 28,
            ...
            'header_footer_pattern' => array(
                'label' => 'Header and Footer pattern',
                'type' => 'WP_Customize_Image_Control',
                'rules' => array(),
                'section' => 'styling',
                'formIndex' => 30,
            ...
            'enable_widget_title_black_background' => array(
                'label' => 'Enable Widget Title Black Background',
                'type' => 'checkbox',
                'rules' => array(),
                'section' => 'styling',
                'formIndex' => 37,
            ),
            'disable_widget_background' => array(
                'label' => 'Disable Widget Background',
                'type' => 'checkbox',
                'rules' => array(),
                'section' => 'styling',
                'formIndex' => 38,
