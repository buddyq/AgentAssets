...
//        $html .= '</p>';
        ...
        $html .= '<input name="micu_business_phone" class="text_input" type="number" id="micu_business_phone" value="'.$businessPhone.'">';
        $html .= '</p>';
        ...
        $html .= '<input name="micu_mobile_phone" class="text_input" type="number" id="micu_mobile_phone" value="'.$mobilePhone.'">';
        $html .= '</p>';
