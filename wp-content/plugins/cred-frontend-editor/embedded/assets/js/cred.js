...
//            }
        ...
        fieldOutput: function (field, form_id, form_name, WPML, pad)
        {
            ...
            if (field)
            {
                ...
                if ('checkbox' != field.type) {
                    ...
                    if (WPML)
                    {
                        field_out.push("[wpml-string context='" + cred_settings._current_page + "-" + form_name + "-" + form_id + "' name='" + field.name + "']" + field.name + "[/wpml-string]");
                    } else
                    {
        ...
        groupOutput: function (group, fields, conditions, obj, form_id, form_name, WPML, pad)
        {
            ...
            if (WPML)
            {
                group_out.push(pad + PAD + "<div class='cred-header'><h3>[wpml-string context='" + cred_settings._current_page + "-" + form_name + "-" + form_id + "' name='" + group + "']" + group + "[/wpml-string]</h3></div>");
            } else
            {
        ...
        taxOutput: function (tax, form_id, form_name, WPML, pad)
        {
            ...
            if (WPML)
                tax_out.push(pad + PAD + "<div class='cred-header'><h3>[wpml-string context='" + cred_settings._current_page + "-" + form_name + "-" + form_id + "' name='" + tax.label + "']" + tax.label + "[/wpml-string]</h3></div>");
            else
