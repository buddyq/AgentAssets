            ...
            if (
                ...
                /* $out='';
                  ...
                  return $out; */
                    ...
                    array_key_exists('custom_fields', $this->out_['fields']) &&
                    is_array($this->out_['fields']['custom_fields']) &&
                    in_array(strtolower($field), array_keys($this->out_['fields']['custom_fields']))
            ) {
                if ($post != $post_type)
                    return '';
