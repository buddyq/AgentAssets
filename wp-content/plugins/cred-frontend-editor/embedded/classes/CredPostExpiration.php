...
class CRED_PostExpiration {
    ...
    public function cred_pe_display_notice() {
        ?>
        <div class="error">
            <p><?php _e('CRED Post Expiration plugin needs the <a href="https://wp-types.com/home/toolset-components/?utm_source=credplugin&utm_campaign=cred&utm_medium=cred-post-expiration&utm_term=Get%20CRED#cred" target="_blank"><strong>CRED Frontend Editor</strong></a> plugin to be installed and activated.', $this->_localization_context); ?></p>
        </div>
        <?php
    }
