...
$cred_help = array(
    ...
    'add_post_forms_to_site' => array(        
        'link' => 'https://wp-types.com/documentation/user-guides/creating-cred-forms/#designing-the-cred-post-form',
        'text' => __('How to add Post Forms to your site', 'wp-cred')
    ),
    'add_user_forms_to_site' => array(        
        'link' => 'https://wp-types.com/documentation/user-guides/cred-user-forms/#designing-the-cred-user-form',
    ...
    'scaffold_settings' => array(
        'link' => 'http://wp-types.com/documentation/user-guides/cred-scaffold-output/',
    ...
    'fields_settings' => array(
        'link' => 'http://wp-types.com/documentation/user-guides/inserting-post-fields/',
