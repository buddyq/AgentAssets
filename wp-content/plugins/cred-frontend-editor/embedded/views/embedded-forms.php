...
<div class="wrap">
    <h2><?php _e('CRED Post Forms', 'wp-cred'); ?><a class="add-new-h2 js-open-promotional-message" href="<?php echo CRED_CRED::$help['add_post_forms_to_site']['link']; ?>"><?php _e('Add New', 'wp-cred'); ?></a>
    <a class="cred-help-link js-open-promotional-message" href="<?php echo CRED_CRED::$help['add_post_forms_to_site']['link']; ?>" target="_blank" title="<?php echo esc_attr(CRED_CRED::$help['add_post_forms_to_site']['text']); ?>">
