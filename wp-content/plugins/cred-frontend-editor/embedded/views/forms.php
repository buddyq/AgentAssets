...
<div class="wrap">
    ...
    <h2><?php _e('Post Forms', 'wp-cred'); ?><a class="add-new-h2" href="<?php echo $url; ?>"><?php _e('Add New', 'wp-cred'); ?></a>
        <?php if (false) { ?>
            <a class="cred-help-link" href="<?php echo CRED_CRED::$help['add_post_forms_to_site']['link']; ?>" target="_blank" title="<?php echo esc_attr(CRED_CRED::$help['add_post_forms_to_site']['text']); ?>">
    ...
    <table class="wpcf-types-form-table widefat js-wpcf-slugize-container">
        <thead>
            <tr>
                <th><?php _e('Manage non-Toolset Post Fields with CRED', 'wp-cred'); ?></th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td>
                    <p>
                        <?php _e('You can manage non-Toolset Post Fields by setting field type and assign field attributes. Then you can use them in CRED forms.', 'wp-cred'); ?>
                        <?php
                        $fields_control_url = esc_url(
                                add_query_arg(
                                        array('page' => 'CRED_Fields'), admin_url('admin.php')
                                )
                        );
                        ?>
                        <a class="button" href="<?php echo $fields_control_url; ?>"><?php _e('Manage non-Toolset Post Fields', 'wp-cred'); ?></a>
                    </p>
                </td>
            </tr>
        </tbody>
