 ...
 * 
 */
class CRED_Custom_User_Fields_List_Table extends WP_List_Table implements CRED_Singleton {

    private $_post_type = 'cred-user-form';
    ...
    function get_columns() {
        return $columns = array(
            ...
            'cred_cred_type' => __('CRED User Field Type', 'wp-cred'),
    ...
    function prepare_items() {
        ...
        $show_private = false;
        if (isset($_REQUEST['show_private']) && '1' == $_REQUEST['show_private']) {
            if (!empty($_POST) && !isset($_POST['show_private']))
                $show_private = false;
            else
                $show_private = true;
        }
        ...
        $perpage = 10; //getCurrentScreenPerPage();
