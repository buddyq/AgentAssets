 ...
 * 
 */
class CRED_User_Forms_List_Table extends WP_List_Table implements CRED_Singleton {
    ...
    function display_rows() {
        ...
        $form_types = apply_filters('cred_admin_form_type_options', array(
            "new" => __('Create user', 'wp-cred'),
            "edit" => __('Edit user', 'wp-cred')
                ), '', null);
            ...
            foreach ($columns as $column_name => $column_display_name) {
                ...
                switch ($column_name) {
                    ...
                    case "cred_user_role":
                        ...
                        $r = empty($settings->form['user_role']) ? __('All', 'wp-cred') : @implode(", ", json_decode($settings->form['user_role']));
