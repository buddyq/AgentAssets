                ...
                <table class='cred-table' cellpadding=0 cellspacing=0>
                    <tr>
                        <td>
                            ...
                            <a class='cred-help-link' href='<?php echo $help['content_edit_user_shortcode_settings']['link']; ?>' target='<?php echo $help_target; ?>' title="<?php echo esc_attr($help['content_edit_user_shortcode_settings']['text']); ?>">
                                <i class="icon-question-sign"></i>
                                <span><?php echo $help['content_edit_user_shortcode_settings']['text']; ?></span>
                            </a>
                        </td>
                                ...
                                <td colspan=2>
                                    <label class='cred-label'><input type='radio' class='cred-advanced-options-radio cred-radio-10' name='cred-user-edit-how-to-display' value='insert-link' />
                                        ...
                                        <span id='cred-edit-link-text-container'>
                                            (<?php _e('text:', 'wp-cred'); ?><input type='text' id='cred-user-edit-html-text' name='cred-user-edit-html-text' value='Edit %TITLE%' />)
                                        </span>
                                    </label>
                                </td>
                            </tr>
                ...
                <table class='cred-table' cellpadding=0 cellspacing=0>
                    <tr>
                        <td>
                            ...
                            <a class='cred-help-link' href='<?php echo $help['content_creation_shortcode_user_settings']['link']; ?>' target='<?php echo $help_target; ?>' title="<?php echo esc_attr($help['content_creation_shortcode_user_settings']['text']); ?>" >
                                <i class="icon-question-sign"></i>
                                <span><?php echo $help['content_creation_shortcode_user_settings']['text']; ?></span>
                            </a>
                        </td>
                    </tr>
                </table>
                ...
                <table class='cred-table' cellpadding=0 cellspacing=0>
                    <tr>
                        <td>
                            ...
                            <a class='cred-help-link' href='<?php echo $help['content_creation_shortcode_post_settings']['link']; ?>' target='<?php echo $help_target; ?>' title="<?php echo esc_attr($help['content_creation_shortcode_post_settings']['text']); ?>" >
                                <i class="icon-question-sign"></i>
                                <span><?php echo $help['content_creation_shortcode_post_settings']['text']; ?></span>
                            </a>
                        </td>
                    </tr>
                </table>
