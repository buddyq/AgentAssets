...
<div id="cred_notification_settings_panel-<?php echo $ii; ?>" class='cred_notification_settings_panel cred_validation_section' style="display:none;">
    ...
    <fieldset class="cred-fieldset">
        ...
        <p class="cred-label-holder">
            <label>
                <?php _e('Notification e-mail subject:', 'wp-cred'); ?>
            </label>
        </p>
    ...
    <fieldset class="cred-fieldset">
        ...
        <div id="cred_mail_body_placeholders-<?php echo $ii; ?>" class="wpcf-wysiwyg">
            <label class="cred-label"><?php _e('Notification mail body:', 'wp-cred'); ?></label>
            <?php
