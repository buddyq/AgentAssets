...
<div class="wrap">
    ...
    <a class="cred-help-link" href="<?php echo CRED_CRED::$help['add_user_forms_to_site']['link']; ?>" target="_blank" title="<?php echo esc_attr(CRED_CRED::$help['add_user_forms_to_site']['text']); ?>">
	...
	<table class="wpcf-types-form-table widefat js-wpcf-slugize-container">
		<thead>
			<tr>
				<th><?php _e( 'Manage user fields in CRED forms', 'wp-cred' ); ?></th>
			</tr>
		</thead>
		<tbody>
			<tr>
				<td>
					<p>
						<?php _e( 'You can manage other user fields by setting field types and assign field attributes.', 'wp-cred' ); ?>
						<?php
						$fields_control_url = esc_url(
							add_query_arg(
								array( 'page' => 'CRED_User_Fields' ),
								admin_url( 'admin.php' )
							)
						);
						?>
						<a class="button" href="<?php echo $fields_control_url; ?>"><?php _e( 'Manage user fields', 'wp-cred' ); ?></a>
					</p>
				</td>
			</tr>
		</tbody>
