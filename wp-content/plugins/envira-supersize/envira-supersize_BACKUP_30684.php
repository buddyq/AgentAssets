...
/**
>>>>>>> 903d025a3de36a256e3e7cbe4012471c3edeeb54
...
function envira_supersize_load( $data ) {
    ...
    if ( ! Envira_Gallery_Shortcode::get_instance()->get_config( 'supersize', $data ) || in_array( Envira_Gallery_Shortcode::get_instance()->get_config( 'lightbox_theme', $data ), array( 'space_dark', 'space_light' ) ) ) {
        return;
    }
