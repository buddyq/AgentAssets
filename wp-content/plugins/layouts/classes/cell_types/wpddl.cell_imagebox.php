            ...
            function imagebox_cell_content_callback() {
                ...
                <?php endif;?>
                    ...
                    <?php if( $size === 'original'):?>
                        <img src="<?php the_ddl_field('box_image'); ?>" <?php echo 'class="'.$classes.'"';?> <?php echo $title_attr;?> <?php echo $alt_attr; ?> <?php echo $data_attribute_img;?> />
                    <?php else:
                        $img = get_attachment_field_url('box_image', $size);
                    ?>
                    <img src="<?php echo $img[0]; ?>" width="<?php echo $img[1]; ?>" height="<?php echo $img[2]; ?>" <?php echo 'class="'.$classes.'"';?> <?php echo $title_attr;?> <?php echo $alt_attr; ?>  <?php echo $data_attribute_img;?> />
                    <?php endif;?>
