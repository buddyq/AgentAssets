...
class WPDD_layout_cell_text_factory extends WPDD_layout_cell_factory{
	...
	public function get_cell_info($template) {
		...
		$template['name'] = __('Visual Editor (post fields, text and images)', 'ddl-layouts');
		$template['description'] = __('Display current post\'s fields, static text, images and any other media that you can include using the WordPress visual editor.
', 'ddl-layouts');
		$template['button-text'] = __('Assign Visual editor (post fields, text and images) Cell', 'ddl-layouts');
		$template['dialog-title-create'] = __('Create a Visual editor (post fields, text and images) Cell', 'ddl-layouts');
		$template['dialog-title-edit'] = __('Edit Visual editor (post fields, text and images) Cell', 'ddl-layouts');
