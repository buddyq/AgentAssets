...
if (!class_exists('Layouts_cell_views_content_grid')) {
    class Layouts_cell_views_content_grid{
            ...
            if (function_exists('register_dd_layout_cell_type')) {
                register_dd_layout_cell_type($this->cell_type, 
                    array(
                        ...
                        'dialog-template-callback' => array(__CLASS__, 'views_content_grid_dialog_template_callback'),
        ...
        public static function views_content_grid_dialog_template_callback() {
            global $WP_Views;
            ob_start();
