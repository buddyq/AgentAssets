...
class WPDD_layout_cell_widget_area_factory extends WPDD_layout_cell_factory{
	...
	public function get_cell_info($template) {
		...
		$template['description'] = __('Display a WordPress Widget Area. You will be able to select a widgets area that comes from the theme.', 'ddl-layouts');
			...
			<div class="cell-content">
				<div class="cell-preview">
					<div class="ddl-widget-area-preview">
						...
						<img src="<?php echo WPDDL_RES_RELPATH . '/images/cell-icons/widgets-area.svg'; ?>" height="130px">
					</div>
			</div>
			</div>
		<?php
	...
	private function _dialog_template() {
		...
		<div class="ddl-dialog-footer no-style-dialog-footer save-new-sidebar-buttons js-widget-area-footer hidden">
			...
			<input type="button" class="button-primary js-create-the-new-sidebar" value="<?php _e('Create the new widget area', 'ddl-layouts'); ?>">
		</div>
