...
class WPDDL_Templates_Settings{
    ...
    private function __construct(){
        ...
        self::$DEFAULT_MESSAGE_TEXT = __('Do you want this page to look different?', 'ddl-layouts');
        $this->init();
    }
    ...
    private function init_hooks(){
        ...
        add_filter( 'template_include', array( $this, 'get_default_template' ), 1, 1 );
    ...
    public function get_default_message(){
            return $this->get_option_value( self::DEFAULT_MESSAGE );
    }
    ...
    public function get_default_user(){
        return $this->get_option_value( self::TEMPLATE_OPTION_USER );
    }

    public function get_default_value(){
            return $this->get_option_value( self::DEFAULT_VALUE );
    }
