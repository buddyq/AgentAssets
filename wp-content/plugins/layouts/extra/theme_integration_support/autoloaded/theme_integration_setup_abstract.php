...
abstract class WPDDL_Theme_Integration_Setup_Abstract {
    ...
    public function add_bootstrap_support() {
        ...
        $bootstrap_js_url = $bootstrap_url . '/js/bootstrap.min.js';
        wp_register_script( 'bootstrap', $bootstrap_js_url, array( 'jquery' ), '3.3.5', true );
    ...
    public function integration_setup_message(){
        $this->message = new WPDDL_Layouts_Integration_Setup_Message();
        $this->message->do_notice();
    }
    ...
    public function register_layouts_settings_items( $sections, $settings ){
        ...
        $sections['toolset-load-layouts'] = array(
            ...
            'title'		=> sprintf(__( 'Load default layouts for %s theme', 'ddl-layouts' ), $this->get_current_theme_name() ),
