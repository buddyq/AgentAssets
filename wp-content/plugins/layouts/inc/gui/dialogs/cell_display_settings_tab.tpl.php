<div class="ddl-form js-css-styling-controls css-styling-controls">
	...
	<div class="ddl-fields-description-wrap">
        ...
        <p class="ddl-fields-description"><?php printf(__('All layout %s will appear inside an HTML tag. By default, this is a DIV tag. Here, you can change the HTML tag for the cell, add classes and an ID to it. Learn more about %sstyling layout cells%s.', 'ddl-layouts'), $dialog_type === 'row' ? 'rows' : 'cells', '<a href="#">', '</a>');?></p>
    </div>
