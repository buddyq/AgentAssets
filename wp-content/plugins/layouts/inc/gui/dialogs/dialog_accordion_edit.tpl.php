<div class="ddl-dialogs-container"> <!-- The create a new layout popup -->
	...
	<div class="ddl-dialog" id="ddl-accordion-edit">
		...
		<div class="ddl-dialog-footer">
			...
			<button data-close="yes" class="button button-primary js-accordion-dialog-edit-save"><?php _e('Save and close','ddl-layouts') ?></button>
		</div>
