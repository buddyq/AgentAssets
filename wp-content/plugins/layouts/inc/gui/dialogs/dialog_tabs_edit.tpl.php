<div class="ddl-dialogs-container"> <!-- The create a new layout popup -->
	...
	<div class="ddl-dialog" id="ddl-tabs-edit">
		...
		<div class="ddl-dialog-footer">
			...
			<button data-close="no" class="button button-primary js-tabs-dialog-edit-save" data-create-text="<?php _e('Create','ddl-layouts') ?>" data-update-text="<?php _e('Save','ddl-layouts') ?>"><?php _e('Save','ddl-layouts') ?></button>
			<button data-close="yes" class="button button-primary js-tabs-dialog-edit-save"><?php _e('Save and close','ddl-layouts') ?></button>
		</div>
