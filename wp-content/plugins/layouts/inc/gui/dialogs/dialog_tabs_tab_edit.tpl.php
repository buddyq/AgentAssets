<div class="ddl-dialogs-container">
	...
	<div class="ddl-dialog" id="ddl-tab-edit">
	...
	<div class="ddl-dialog-footer">
		...
		<button data-close="yes" class="button button-primary js-tab-dialog-edit-save js-save-dialog-settings"><?php _e('Save and close','ddl-layouts') ?></button>
	</div>
