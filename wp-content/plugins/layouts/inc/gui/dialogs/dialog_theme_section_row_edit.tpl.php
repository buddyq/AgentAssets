...
<div class="ddl-dialogs-container">
	...
	<div class="ddl-dialog" id="ddl-theme-section-row-edit">
		...
		<div class="ddl-dialog-footer">
			...
			<button class="button button-primary js-theme-section-row-dialog-edit-add-row"><?php _e('Create and close','ddl-layouts') ?></button>
			<button class="button button-primary js-theme-section-row-dialog-edit-save js-save-dialog-settings"><?php _e('Save and close','ddl-layouts') ?></button>
		</div>
