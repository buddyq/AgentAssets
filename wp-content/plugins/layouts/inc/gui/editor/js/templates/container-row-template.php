<script type="text/html" id="container-row-template">
	...
	<div class="row-toolbar js-row-toolbar">
		...
		<div class="row-actions js-row-actions">
			<i class="icon-pencil fa fa-pencil js-row-edit js-row-edit-icon" data-tooltip-text="Edit row"></i>  <?php // TODO: Localize data attribute  ?>
			<i class="fa fa-remove icon-remove icon-remove-enabled js-row-remove js-row-remove-icon" data-tooltip-text="Remove row"></i>  <?php // TODO: Localize data attribute  ?>
		</div>
	</div>
	<# } #>
