...
<div class="dd-layouts-wrap">
		...
		<p class="dd-layouts-breadcrumbs js-dd-layouts-breadcrumbs-wrap">
			...
			<span class="layout-title js-layout-title active">
				<?php echo esc_attr(apply_filters("layout_title", $post->post_title)); ?>
			</span>
		</p>
		...
		<div class="editor-toolbar js-editor-toolbar">
			...
			<?php else: ?>
				<p class="save-button-wrap">
                    <button href="#post_name" class="button button-large button-secondary hide-if-no-js js-view-layout"><?php _e( 'Preview layout', 'ddl-layouts' ); ?></button>
			...
			<p class="undo-redo-wrap">
				<button class="js-undo-button button button-large hidden" value="Undo" name="undo"><i class="icon-undo fa fa-undo"></i> <?php _e('undo','ddl-layouts'); ?></button>
				<button class="js-redo-button button button-large hidden" name="redo"><i class="fa fa-repeat icon-repeat"></i> <?php _e('redo','ddl-layouts'); ?></button>
				...
				<input id="compact-cell-view" class="button button-large compact-cell-view" type="button"
						value="<?php _e('Compact display', 'ddl-layouts'); ?>"
						data-compact="<?php _e('Compact display', 'ddl-layouts'); ?>"
						data-normal="<?php _e('Full display', 'ddl-layouts'); ?>"
						name="compact-cell-view">
				<span id="edit-layout-button"><a href="#post_name" class="button button-large hide-if-no-js js-edit-layout-settings"><?php _e( 'Set parent layout', 'ddl-layouts' ); ?></a></span>
                    ...
                    <span id="set-as-parent-layout-button" class="js-set-as-parent-layout-button hidden js-has-parent"><a href="#post_name" class="button button-large hide-if-no-js js-set-as-parent-layout"><i class="fa fa-home icon-home-parent"></i><?php _e( 'Set as default parent', 'ddl-layouts' ); ?></a></span>
