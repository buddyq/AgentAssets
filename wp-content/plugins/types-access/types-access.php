...
require TACCESS_PLUGIN_PATH . '/toolset/onthego-resources/loader.php';
onthego_initialize(TACCESS_PLUGIN_PATH . '/toolset/onthego-resources', TACCESS_PLUGIN_URL . '/toolset/onthego-resources/');

require TACCESS_PLUGIN_PATH . '/toolset/toolset-common/loader.php';
toolset_common_initialize(TACCESS_PLUGIN_PATH . '/toolset/toolset-common', TACCESS_PLUGIN_URL . '/toolset/toolset-common/');
...
// Cacher
TAccess_Loader::load('CLASS/Cacher');
Access_Cacher::init();
// Helper
...
function otg_access_plugin_row_meta( $plugin_meta, $plugin_file, $plugin_data, $status ) {
	...
	if ( $plugin_file == $this_plugin ) {
		$plugin_meta[] = sprintf(
				...
				'https://wp-types.com/version/access-2-2-1/?utm_source=accessplugin&utm_campaign=access&utm_medium=release-notes-plugins-list&utm_term=Access 2.2.1 release notes',
				__( 'Access 2.2.1 release notes', 'wpcf-access' )
			);
	}
	return $plugin_meta;
}
