				...
				if ( $arrange_by_usage ) {
					...
					<p class="add-new-view js-add-new-view">
						<a class="button js-wpv-views-archive-add-new wpv-views-archive-add-new" href="#">
							<i class="icon-plus fa fa-plus"></i><?php _e('Add new WordPress Archive','wpv-views') ?>
						</a>
					</p>
					<?php
				...
				if ( 'trash' == $current_post_status && $is_search ) {
					...
					<p>
						<?php
							...
							printf(
									'<a href="#" class="button js-wpv-views-archive-create-new"><i class="icon-plus fa fa-plus"></i> %s</a>',
