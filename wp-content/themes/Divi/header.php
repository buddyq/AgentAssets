			...
			?>
				<div class="logo_container">
					...
					<?php if ( get_theme_mod( 'image' ) ) : ?>
					   <span class="logo">
							<a href='<?php echo esc_url( home_url( '/' ) ); ?>' title='<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>' rel='home'><img id="logo"  src='<?php echo esc_url( get_theme_mod( 'image' ) ); ?>'  alt='<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>'></a>
						</span>
					<?php else : ?>
