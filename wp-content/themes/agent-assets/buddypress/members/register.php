...
<div id="buddypress">
	...
	<div class="page" id="register-page">
		...
		<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
			...
			<p><?php // _e( 'Registering for AgentAssets is easy. Just fill in the fields below, and we\'ll get a new account set up for you in no time.', 'buddypress' ); ?></p>

			<h3 style="text-align: center; line-height:2; padding: 1rem 3rem;"><?php _e( 'To take advantage of the convenience of AgentAssets Microsites, you\'ll first need to sign up.', 'buddypress' ); ?></h3>
			<?php
			...
			<div class="register-section" id="basic-details-section">
				...
				<h2><?php _e( 'Your Account Details', 'buddypress' ); ?></h2>
			...
			<?php if ( bp_is_active( 'xprofile' ) ) : ?>
				...
				<div class="register-section" id="profile-details-section">
					...
					<h2><?php _e( 'Your Agent Details', 'buddypress' ); ?></h2>
			...
			<div class="submit main-color">
				<input type="submit" class="avia-color-theme-color avia-button avia-size-large" name="signup_submit" id="signup_submit" value="<?php esc_attr_e( 'Complete Sign Up', 'buddypress' ); ?>" />
			</div>
