...
// Adds styles for create site page
wp_enqueue_style( 'signup-styles', get_stylesheet_directory_uri() . '/inc/css/signup_styles.css' );
  ...
  echo '<div class="step">';
	...
	<form id="setupform" method="post" action="">
		...
		<div class="avia-button-wrap avia-button-center  avia-builder-el-0  el_before_av_heading  avia-builder-el-first  ">
			<a onclick="document.getElementById('setupform').submit();" href="javascript:{}" title="Create Site" class="avia-button avia-icon_select-no avia-color-theme-color avia-size-x-large avia-position-center ">
				<span class="avia_iconbox_title">Create Site</span>
			</a>
		</div>
                ...
                <article class="iconbox iconbox_top main_color avia-builder-el-5 avia-builder-el-no-sibling" itemscope="itemscope" itemtype="https://schema.org/CreativeWork">
                    <div class="iconbox_content">
                        ...
                        <div class="iconbox_content_container" itemprop="text">
                            <p class="center"><strong>Using your own domain name?</strong></p> <strong><br><a href="<?php echo esc_url(get_permalink('11551'));?>">DO THIS NEXT!</a></strong></p>
