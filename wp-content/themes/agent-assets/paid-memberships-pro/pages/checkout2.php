...
<form id="pmpro_form" class="pmpro_form" action="<?php if(!empty($_REQUEST['review'])) echo pmpro_url("checkout", "?level=" . $pmpro_level->id); ?>" method="post">
	...
	<?php } ?>
	<h1><?php _e($pmpro_level->name.' Membership Level', 'pmpro');?></h1>
	
	<div id="after_section_1" class="main_color av_default_container_wrap container_wrap fullsize">
	    <div class="container">
	        <div class="template-page content  av-content-full alpha units">
	            <div class="post-entry post-entry-type-page post-entry-11506">
	                <div class="entry-content-wrapper clearfix">
	                    <div class="flex_column av_one_fourth  flex_column_div av-zero-column-padding first  avia-builder-el-8  el_after_av_section  el_before_av_one_half  avia-builder-el-first  " style="border-radius:0px; "></div>
	                    <p></p>
	                    <div class="flex_column av_one_half  flex_column_div av-zero-column-padding   avia-builder-el-9  el_after_av_one_fourth  el_before_av_one_fourth  " style="border-radius:0px; ">
	                        <div style="padding-bottom:10px;" class="av-special-heading av-special-heading-h3  blockquote modern-quote modern-centered  avia-builder-el-10  el_before_av_icon_box  avia-builder-el-first  my-class ">
	                            <h2 class="av-special-heading-tag " itemprop="headline"><?php _e($pmpro_level->name.' Membership Level', 'pmpro');?></h2>
	                        ...
	                        <article class="iconbox iconbox_top main_color avia-builder-el-11 el_after_av_heading avia-builder-el-last my-box" itemscope="itemscope" itemtype="https://schema.org/CreativeWork">
	                            <div class="iconbox_content">
	                                <header class="entry-content-header">
	                                    <div class="iconbox_icon heading-color" aria-hidden="true" data-av_icon="" data-av_iconfont="entypo-fontello"></div>
	                                    <h3 class="iconbox_content_title" itemprop="headline">Your Package</h3></header>
	                                <div class="iconbox_content_container" itemprop="text">
										...
										<div id="pmpro_level_cost">
											<?php if($discount_code && pmpro_checkDiscountCode($discount_code)) { ?>
												<?php printf(__('<p class="pmpro_level_discount_applied">The <strong>%s</strong> code has been applied to your order.</p>', 'pmpro'), strtoupper($discount_code));?>
											<?php } ?>
										...
										<?php if($pmpro_show_discount_code) { ?>
											...
											<?php if($discount_code && !$pmpro_review) { ?>
												<p id="other_discount_code_p" class=""><a id="other_discount_code_a" href="#discount_code"><?php _e('Click here to change your discount code', 'pmpro');?></a>.</p>
											<?php } elseif(!$pmpro_review) { ?>
												<p id="other_discount_code_p" class=""><?php _e('Are you lucky and have a discount code?', 'pmpro');?> <a id="other_discount_code_a" href="#discount_code"><?php _e('Click here to enter your discount code', 'pmpro');?></a>.</p>
										...
										<div id="other_discount_code_tr" style="display: none;">
												<div>
													<div class="lucky">
														You're in the cool club!
													</div>
													<!-- <label for="other_discount_code"><?php _e('Discount Code', 'pmpro');?></label> -->
													<input id="other_discount_code" name="other_discount_code" type="text" class="input <?php echo pmpro_getClassForField("other_discount_code");?>" size="20" value="<?php echo esc_attr($discount_code)?>" placeholder="Discount Code" />
													<!-- <input type="button" name="other_discount_code_button" id="other_discount_code_button" value="<?php _e('Apply', 'pmpro');?>" /> -->
													<?php echo do_shortcode("[av_button label='Apply Discount' link='manually,#' link_target='' size='large' position='center' icon_select='yes' icon='ue827' font='entypo-fontello' color='theme-color' custom_bg='#444444' custom_font='#ffffff' custom_class='other_discount_code_button']");?>
												</div>
										</div>
										<?php } ?>
	                    ...
	                    <div class="flex_column av_one_fourth  flex_column_div av-zero-column-padding   avia-builder-el-12  el_after_av_one_half  avia-builder-el-last  " style="border-radius:0px; "></div>
	                    <p></p>
	                </div>
	            </div>
	        </div>
	...
	<!-- <thead>
		<tr>
			<th>
				<span class="pmpro_thead-name"><?php _e($pmpro_level->name.' Membership Level', 'pmpro');?></span>
	...
	<script>
		...
		jQuery('#other_discount_code_a').click(function() {
			jQuery('#other_discount_code_tr').show("slow");
			jQuery('#other_discount_code_p').hide("slow");
		...
		jQuery('#other_discount_code_button, .other_discount_code_button').click(function() {
			...
			<tr valign="top">
				<td>
					...
					<div class="pmpro_payment-account-number">
					    ...
					    <div class="col">
					      <label class="input" for="AccountNumber">
					        <span class="label" data-text="Credit Card Number">Credit Card Number</span>
					        <input type="text" class="text-field" name="cc-number" autocomplete="cc-number" data-numeric="" required="">

					        <div class="cards">
					          <img src="/ketone/assets/svg/cc-amex.svg" data-card="cc-amex">
					          <img src="/ketone/assets/svg/cc-discover.svg" data-card="cc-discover">
					          <img src="/ketone/assets/svg/cc-mastercard.svg" data-card="cc-mastercard">
					          <img src="/ketone/assets/svg/cc-visa.svg" data-card="cc-visa">
					        </div>
					      </label>
					    </div>
					  </div>
...
<!--
	...
	<?php if(!empty($_REQUEST['discount_code'])) {?>
		...
		jQuery('#discount_code').bind('change keyup', function() {
			jQuery('#discount_code_button').show("slow");
		});
	<?php } ?>
