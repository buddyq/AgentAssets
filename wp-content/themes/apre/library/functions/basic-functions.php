...
function aveone_posts_slider() {
  ...
  $gallery_data = get_post_meta( $gallery_id, '_eg_gallery_data', true );
	...
	add_action('wp_head','apre_gallery_styles');
	function apre_gallery_style(){
		?>
		<style>
			.size-apre-slider{
				height: 310px;
...
<?php
// echo wp_get_attachment_image( $attachment_id, "apre-slider" );
echo '<img src="'.$image['src'].'" alt="'.$image['alt'].'" style="width: 672px;" />';?>
