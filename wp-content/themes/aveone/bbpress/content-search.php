...
<div id="bbpress-forums">
	<div class="search-page-search-form">
		<h2><?php _e('Need a new search?', 'aveone'); ?></h2>
		<p><?php _e('If you didn\'t find what you were looking for, try a new search!', 'aveone'); ?></p>

    <form role="search" method="get" class="bbp-search-form" id="searchform" action="<?php bbp_search_url(); ?>">
			<div>
				<label class="screen-reader-text hidden" for="bbp_search"><?php _e( 'Search for:', 'bbpress' ); ?></label>
				<input type="hidden" name="action" value="bbp-search-request" />
				<input tabindex="<?php bbp_tab_index(); ?>" type="text" value="<?php echo esc_attr( bbp_get_search_terms() ); ?>" placeholder="<?php _e( 'Search the Forum...', 'aveone' ); ?>" name="bbp_search" id="bbp_search" />
