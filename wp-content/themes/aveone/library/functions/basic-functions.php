...
<ul id="slides">
    ...
    <?php $number_items = aveone_get_option('evl_posts_number','5'); 
    
    $slider_content = aveone_get_option('evl_posts_slider_content','recent');
    $slider_content_category = '';
    $slider_content_category = aveone_get_option('evl_posts_slider_id','');
...
if(has_post_thumbnail()) {
    ...
    the_post_thumbnail('full');
     ...
     } else {   $image = aveone_get_first_image(); 
                      if ($image):
                      echo '<img src="'.$image.'" alt="';the_title();echo'" />';
                      endif;
               } ?> 
