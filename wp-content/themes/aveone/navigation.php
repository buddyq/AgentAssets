...
<?php if (function_exists('wp_pagenavi')) : ?>
        <?php wp_pagenavi(); ?>
    <?php else: ?>
	<div class="col-sm-6 col-md-6 nav-next"><?php previous_posts_link( '<div class="btn btn-left icon-arrow-left icon-big">'.__( 'Newer Entries', 'aveone' ).'</div>' ); ?></div>
  <div class="col-sm-6 col-md-6 nav-previous"><?php next_posts_link( '<div class="btn btn-right icon-arrow-right icon-big">'.__( 'Older Entries', 'aveone' ).'</div>' ); ?></div>
  <?php endif; ?>
<!--END .navigation-links-->
</div>
<div class="clearfix"></div> 
