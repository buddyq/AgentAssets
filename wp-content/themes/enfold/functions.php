...
$avia_config['admin_notices'] = array(
	...
	//update to version 4.3 - display notice and link to blog post	
	'performance_update' 	=> array('class'=>'info', 	 'msg' => 
			"<strong>" .__('Attention:','avia_framework') . "</strong> " . 
			__('The last Enfold update added a lot of performance options. Make sure to read more about it ','avia_framework') . 
			"<a href='https://kriesi.at/archives/enfold-4-3-performance-update' target='_blank'>". 
			__('here','avia_framework') . "</a><br><br>".
			__('If you are running a caching plugin please make sure to reset your cached files, since the CSS and JS file structure of the theme changed heavily','avia_framework')
	),	
