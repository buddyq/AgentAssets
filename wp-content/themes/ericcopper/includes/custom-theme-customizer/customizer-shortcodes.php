...
class Customizer_Shortcodes {
	public function __construct() {
		...
		add_shortcode( 'customizer-image-gallery', array( &$this, 'customizer_image_gallery_shortcode' ) );
	}
	...
	public function customizer_image_gallery_shortcode( $atts ) {
		$ids_array = get_theme_mod( 'featured_image_gallery' );
		if ( is_array( $ids_array ) && ! empty( $ids_array ) ) {
			$ids = implode( ',', $ids_array );
			$atts['include'] = $ids;
		}
		return '<div style="text-align: center;">' . gallery_shortcode( $atts ) . '</div>';
	}
