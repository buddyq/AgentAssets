        ...
        */
        ...
        if($headerS['header_position'] != "header_top") do_action('ava_main_header_sidebar');
				 ...
				 $output .= "<div class='container av-logo-container'>";
					...
					$output .= '<div class="inner-container copper-heading">';
					...
					$output .= '<h1><a href=' .$site_url. '>'.$site_title.'</a></h1>';
					$output .= '<h3>'.$site_description.'</h3>';
					$output .= '</div>';
						...
						*/
						...
						{
							$addition = "<img src='".$headerS['header_replacement_logo']."' class='alternate replacement_logo' alt='' title='' />";
						}
			        ...
			        $output .= "</div>";
						...
						/* header-counter */
						// $output .= '<div id="header-counter">Word</div>';
						// $output .= '<a href="' . home_url( 'agentassets-account/agentassets-levels' ) . '" id="credit-button"><div class="credit-button pill">Sites Remaining: <span>' . $object->current . '</span></div></a>';
